...
def elements_number(arr)
  ...
  puts "Cette array contient " +  arr.length.to_s + " handle. \n\n\n"
end
...
def elements_short(arr)
  ...
  puts "Le handle le plus court de cette liste est: #{arr.min_by {|x| x.length}}.\n\n "
end
...
def five(arr)
  ...
  puts "Il y a un total de #{arr.count {|x| x.length == 5}} handle avec 5 caractères. \n\n\n"
end
